    ...
    <section id="gallery" className="py-20 md:py-28 bg-[#FFFBF5] relative overflow-hidden select-none">
      <div className="max-w-[1440px] mx-auto relative z-10">
        ...
        >
          <div 
            ref={scrollRef}
            className="flex space-x-4 md:space-x-10 overflow-x-auto scrollbar-hide pb-8 cursor-grab active:cursor-grabbing md:px-16"
            style={{ 
              scrollbarWidth: 'none', 
        ...
        {/* Visit Full Gallery CTA: Capsule design with refined museum-like feel */}
        <div className="mt-16 flex justify-center">
          <button className="group relative px-10 py-3.5 rounded-full border border-[#800000]/20 bg-[#800000]/[0.02] text-[#800000] font-medium text-base transition-all duration-500 ease-out hover:bg-[#800000] hover:text-white hover:border-[#800000] hover:shadow-lg hover:shadow-[#800000]/10 hover:-translate-y-0.5 flex items-center space-x-3">
            <span>Visit Full Gallery</span>
            <svg 
              className="w-5 h-5 transform transition-all duration-500 group-hover:translate-x-1.5 opacity-60 group-hover:opacity-100" 
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
